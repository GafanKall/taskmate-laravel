...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('../css/main/work.css') }}">
    <link href='https://unpkg.com/boxicons@2.0.7/css/boxicons.min.css' rel='stylesheet'>
    <title>TaskMate - Work Tasks</title>
</head>
<body>
    <header class="header-section">
        <div class="text">Work Tasks</div>
    ...
    <section class="home-section">
        ...
        <div class="list-task" id="taskList">
            @php
            $workTasks = \App\Models\Task::where('user_id', auth()->id())
                ->where('category', 'work')
                ->orderBy('completed')
            ...
            @else
                <div class="empty-task-message">
                    <p>No work tasks available. Click "Create Task" to add a new work task.</p>
                </div>
            @endif
        </div>
            ...
            <form id="taskCreateForm">
                ...
                <div class="form-group">
                    ...
                    <select id="taskCategory" name="category" required>
                        <option value="work" selected>🛠️ Work</option>
